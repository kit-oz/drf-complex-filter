...
TEST_CASES = [
    ({"filters": ""}, TestCaseModel.objects.all()),
    ...
    (
        {
            "filters": json.dumps(
                {
                    "type": "operator",
                    "data": {"attribute": "group1", "operator": "=", "value": "GROUP1"},
                }
            )
        },
    ...
    (
        {
            "filters": json.dumps(
                {
                    "type": "operator",
                    "data": {"attribute": "integer", "operator": "=", "value": 2},
                }
            )
        },
    ...
    (
        {
            "filters": json.dumps(
                {
                    "type": "operator",
                    "data": {"attribute": "float", "operator": "=", "value": 2},
                }
            )
        },
    ...
    (
        {
            "filters": json.dumps(
                {
                    "type": "operator",
                    "data": {"attribute": "group1", "operator": "*", "value": "P1"},
                }
            )
        },
    ...
    (
        ...
        TestCaseModel.objects.filter(group1="GROUP3").filter(
            Q(group2="GROUP1") | Q(group2="GROUP2")
        ),
    ),
    ...
    (
        {
            "filters": json.dumps(
                {
                    "type": "operator",
                    "data": {"attribute": "with_empty", "operator": "=", "value": ""},
                }
            )
        },
    ...
    (
        ...
        TestCaseModel.objects.filter(with_empty__isnull=False).filter(
            with_empty__gt=""
        ),
    ),
    # BOOLEAN FIELDS
    (
        {
            "filters": json.dumps(
                {
                    "type": "operator",
                    "data": {"attribute": "boolean", "operator": "=", "value": False},
                }
            )
        },
    ...
    (
        {
            "filters": json.dumps(
                {
                    "type": "operator",
                    "data": {"attribute": "id", "operator": "=", "value": ""},
                }
            )
        },
    ...
    (
        {
            "filters": json.dumps(
                {
                    "type": "operator",
                    "data": {"attribute": "date", "operator": "=", "value": ""},
                }
            )
        },
            ...
            "filters": json.dumps(
                {
                    ...
                    "data": {
                        ...
                        "value": {
                            "func": "date",
                            "kwargs": {"year": 2020, "month": 10, "day": 15},
                        },
                    },
                }
            )
